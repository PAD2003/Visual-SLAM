...
//        cv::subtract(normalizedImg, cv::Scalar_(mean, mean, mean), normalizedImg);
//        cv::divide(normalizedImg, cv::Scalar_(std, std, std), normalizedImg);
//        dstImage[ib] = normalizedImg;
