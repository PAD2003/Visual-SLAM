...
private:
    ...
    void GrabRGBDS(const sensor_msgs::msg::Image::SharedPtr msgRGB, const sensor_msgs::msg::Image::SharedPtr msgD, const sensor_msgs::msg::Image::SharedPtr msgS);
    ...
    void segment_publish(cv::Mat rgbImg, cv::Mat depthImg);
