...
int main(int argc, char **argv)
{
    ...
    for (int ni = 0; ni < nImages; ni++)
    {
        ...
        msk = cv::imread(std::string(argv[4]) + "/" + vstrMaskFilenames[ni], cv::IMREAD_UNCHANGED);
        ...
        pSLAM->TrackRGBD(msk, imRGB, imD, tframe, std::vector<ORB_SLAM3::IMU::Point>(), vstrImageFilenamesRGB[ni]);
